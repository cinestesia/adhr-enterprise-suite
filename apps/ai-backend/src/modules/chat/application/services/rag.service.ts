import { IKnowledgeBasePort, KnowledgeBaseSearchFilters } from "@/modules/shared/domain/ports/knowledge-base.port"

export class RagService {
    private readonly SIMILARITY_THRESHOLD = 0.45
    private readonly MAX_CHUNKS = 4

    constructor(private vectorDb: IKnowledgeBasePort) {}

    async getContext(
        message: string,
        department: string,
        dynamicFilters?: Omit<KnowledgeBaseSearchFilters, 'department'>
    ): Promise<string | null> {
