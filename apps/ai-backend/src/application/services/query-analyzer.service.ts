// apps/ai-backend/src/application/services/query-analyzer.service.ts
import { IChatPort } from '@/domain/ports/chat.port'
import { PromptBuilder } from './prompt-builder.service'
import { VectorSearchFilters } from '@/domain/ports/vector-db.port'

export interface QueryAnalysisResult {
    route: 'RAG' | 'GENERIC' | 'AGENT'
    targetAgent?: 'itAgent' | 'recruitingAgent' // 🌟 AGGIUNTO: Identificativo dell'agente verticale
    optimizedQuery: string
    filters?: Omit<VectorSearchFilters, 'department'>
}
