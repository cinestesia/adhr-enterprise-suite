...
import { ICvExtractorPort } from '@/domain/ports/cv-extractor.port'
import { DocumentParserService } from '../services/document-parser.service' // <--- Nuovo servizio
import { ExtractedCvData, Candidate } from '@/domain/models/candidate.model'
