...
export const RootResponseSchema =  Type.Object({
    status: Type.String(),  // Obbligatorio
    message: Type.String(), // Obbligatorio
    errorCode: Type.Optional(Type.Number()) // Opzionale
});
...
//     password: 'segreto_super_sicuro' // Questo campo verrà rimosso!
//   }
// })
