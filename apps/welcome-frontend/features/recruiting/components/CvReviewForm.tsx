...
import { Mail, Phone, MapPin, User, Briefcase, GraduationCap, Languages, Sparkles, Plus, Trash2 } from 'lucide-react'
  ...
  return (
    <div className="space-y-8 pb-20">
      ...
      <div className="bg-white rounded-xl border border-zinc-100 p-5 shadow-xs space-y-4">
        <div className="flex items-center justify-between border-b border-zinc-50 pb-3">
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-bold text-sm text-zinc-900 uppercase tracking-wider">Dati Personali</h3>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-1">
            ...
            <input 
              ...
              className="w-full text-sm font-medium border border-zinc-200 rounded-lg px-3 py-2 bg-zinc-50/30 focus:border-red-600 focus:bg-white focus:outline-hidden transition"
            />
          </div>
          <div className="space-y-1">
          ...
          <div className="space-y-1">
            <label className="text-xs font-semibold text-zinc-500">Località / Residenza</label>
            <div className="relative">
      ...
      <div className="bg-white rounded-xl border border-zinc-100 p-5 shadow-xs space-y-4">
        <div className="flex items-center justify-between border-b border-zinc-50 pb-3">
          <div className="flex items-center gap-2">
            <Briefcase className="size-5 text-red-600" />
            <h3 className="font-bold text-sm text-zinc-900 uppercase tracking-wider">Esperienza Lavorativa</h3>
          </div>
        </div>

        <div className="space-y-4">
          {formData.experience.map((exp, idx) => (
            <div key={idx} className="group p-4 border border-zinc-100 bg-zinc-50/20 hover:bg-zinc-50/40 rounded-xl space-y-3 relative transition">
              <button 
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                <div className="space-y-1">
                  <label className="text-[10px] font-bold text-zinc-400 uppercase">Ruolo / Qualifica</label>
                  <input 
                    type="text" 
                    value={exp.role} 
                ...
                <div className="space-y-1">
                  <label className="text-[10px] font-bold text-zinc-400 uppercase">Azienda</label>
                  <input 
                    type="text" 
                    value={exp.company} 
                ...
                <div className="space-y-1">
                  <label className="text-[10px] font-bold text-zinc-400 uppercase">Periodo</label>
                  <input 
                    type="text" 
                    value={exp.period || ''} 
              ...
              <div className="space-y-1">
                <label className="text-[10px] font-bold text-zinc-400 uppercase">Mansioni e Attività svolte</label>
                <textarea 
      ...
      <div className="bg-white rounded-xl border border-zinc-100 p-5 shadow-xs space-y-4">
        <div className="flex items-center justify-between border-b border-zinc-50 pb-3">
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-bold text-sm text-zinc-900 uppercase tracking-wider">Istruzione e Formazione</h3>
          </div>
        </div>

        <div className="space-y-4">
          {formData.education.map((edu, idx) => (
            <div key={idx} className="group p-4 border border-zinc-100 bg-zinc-50/20 hover:bg-zinc-50/40 rounded-xl grid grid-cols-1 md:grid-cols-4 gap-3 relative transition">
              <button 
              ...
              <div className="space-y-1 md:col-span-2">
                <label className="text-[10px] font-bold text-zinc-400 uppercase">Titolo di Studio / Corso</label>
                <input 
                  type="text" 
                  value={edu.degree} 
              ...
              <div className="space-y-1">
                <label className="text-[10px] font-bold text-zinc-400 uppercase">Istituto / Università</label>
                <input 
                  type="text" 
              ...
              <div className="space-y-1">
                <label className="text-[10px] font-bold text-zinc-400 uppercase">Anno e Voto</label>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl border border-zinc-100 p-5 shadow-xs space-y-3">
          <label className="text-xs font-bold text-zinc-400 uppercase tracking-wider block">Hard & Soft Skills Estratte</label>
          <div className="flex flex-wrap gap-2">
            {formData.skills.map((skill, i) => (
              <span key={i} className="text-xs bg-zinc-100 hover:bg-zinc-200 text-zinc-800 font-medium px-2.5 py-1 rounded-md transition cursor-default">
                {skill}
              </span>
            ))}
            {formData.skills.length === 0 && <span className="text-xs text-zinc-400 italic">Nessuna skill rilevata</span>}
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl border border-zinc-100 p-5 shadow-xs space-y-3">
          <div className="flex items-center gap-2 border-b border-zinc-50 pb-2">
            ...
            <label className="text-xs font-bold text-zinc-400 uppercase tracking-wider block">Competenze Linguistiche</label>
          </div>
          <div className="flex flex-wrap gap-2">
            {formData.languages.map((lang, i) => (
              <span key={i} className="text-xs bg-red-50 text-red-900 border border-red-100 font-semibold px-2.5 py-1 rounded-md">
                {lang}
              </span>
            ))}
            {formData.languages.length === 0 && <span className="text-xs text-zinc-400 italic">Nessuna lingua rilevata</span>}
          </div>
        </div>
      </div>
