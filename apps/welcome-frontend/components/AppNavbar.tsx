            ...
            <div className="flex items-center gap-4 md:gap-8">
                ...
                <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        <Button variant="ghost" className="relative h-10 w-10 rounded-full p-0 hover:bg-white/10 ring-offset-primary focus-visible:ring-2 focus-visible:ring-white">
                            <Avatar className="h-10 w-10 border-[1.5px] border-white/80 shadow-lg transition-transform group-hover:scale-105 group-hover:border-white">
                                <AvatarImage src="https://robohash.org/ciccio" alt="User" className="bg-white bg-cover" />
                    ...
                    <DropdownMenuContent className="w-64 p-2 shadow-lg shadow-adhr-zinc-shadow border-adhr-zinc-ulight" align="end">
                        <DropdownMenuLabel className="font-normal p-2">
                            <div className="flex flex-col space-y-1">
                                <p className="text-sm font-bold leading-none text-adhr-zinc-strong">Utente</p>
                                <p className="text-xs leading-none text-adhr-zinc-medium font-medium">{user?.email}</p>
                            </div>
                        </DropdownMenuLabel>
