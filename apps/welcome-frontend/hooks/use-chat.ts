...
export function useChat() {
    ...
    const sendMessage = useCallback( async (content: string) => {
        ...
        setMessages( (prev) => { console.log("DEB:", [...prev, usrMsg]); return [...prev, usrMsg] } )
        ...
        try {
            ...
            setError("Non sono riuscito a rispondere. Controlla la connessione o riprova più tardi.");
        } finally {
            setIsLoading(false)
            setIsTyping(false)
        }
    }, [messages]) // se messages cambia scatta una foto della situazione e aggiorna sendMessage
