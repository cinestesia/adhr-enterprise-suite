  ...
  return (
    <div className="space-y-8 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-black tracking-tight text-zinc-900">ADHR Suite Hub</h1>
          <p className="text-zinc-500 font-medium">Benvenuto, Mario. Seleziona un'applicazione per iniziare.</p>
        </div>
            ...
            <Card className="h-full border-none shadow-lg overflow-hidden ring-1 ring-zinc-200 group-hover:ring-[#A00407]/30 group-hover:shadow-xl transition-all">
              <CardContent className="p-0">
                <div className="flex p-6 gap-6">
                  {/* Icon Box */}
                  <div className={`flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl ${app.color} text-white shadow-lg`}>
                  ...
                  <div className="flex-1 pr-8">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      {app.status === "Upcoming" && (
                        <span className="text-[10px] bg-zinc-100 text-zinc-500 px-2 py-0.5 rounded uppercase font-black">Presto</span>
                      )}
                    </div>
