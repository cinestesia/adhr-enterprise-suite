    ...
    <SidebarProvider>
      <div className="flex h-screen w-full overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto bg-secondary/10">
          ...
          <header className="flex h-16 shrink-0 items-center justify-between border-b px-6 bg-[image:var(--background-image-adhr-gradient)] shadow-md text-white sticky top-0 z-10">
                  ...
                  <BreadcrumbItem>
                    <BreadcrumbPage className="text-white font-bold">
                      ...
                      {pathSegments.length === 0 
                        ? routeNames['/'] 
                        : (routeNames[pathname] || pathSegments[pathSegments.length - 1].replace(/-/g, ' '))
                      }
                    </BreadcrumbPage>
                  </BreadcrumbItem>
                </BreadcrumbList>
                ...
                <DropdownMenuContent className="w-60" align="end" forceMount>
                  <DropdownMenuLabel className="font-normal">
                    <div className="flex flex-col space-y-1">
                      <p className="text-sm font-medium leading-none">Nome Utente Keycloak</p>
                      <p className="text-xs leading-none text-muted-foreground">email.utente@adhr.it</p>
                    </div>
                  </DropdownMenuLabel>
