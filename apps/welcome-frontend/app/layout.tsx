...
const specialElite = Special_Elite({ // Vecchia macchina da scrivere. 
...
export default function RootLayoutPage({ children }: Readonly<{children: React.ReactNode}>) {
    return (
        <html lang="it" suppressHydrationWarning>
            <body className={`${geist.variable} ${geistMono.variable} ${specialElite.variable} antialiased`}>
